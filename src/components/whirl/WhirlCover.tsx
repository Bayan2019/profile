...
const WhirlCover = () => {
    return (
        <section
            style={{width:'1440px', height:'479px', margin:'0px auto', padding:'0px auto'}}
        >
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            style={{width:'174px', height:'43px', top:'158.02px', 
                                backgroundColor:'#0070A0', paddingTop:'8px', 
                                color:'#FFFFFF', textAlign:'center', verticalAlign:'middle'}}
                        >Book a demo</div>
                        <div
                            style={{width:'110px', height:'43px', top:'158.02px', 
                                padding:'8px 0px', textAlign:'center', 
                                display:'inline-flex', color:'#0070A0', marginLeft:'5px'}}
                        >Learn more <MdOutlineArrowForwardIos style={{marginTop:'5px'}} /></div>
                    </div>
                </div>
                <img src="/images/IMAGE-2.png" 
                    style={{width:'452px', height:'422px', left:'678px', 
