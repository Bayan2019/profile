...
const HeaderWhirl = () => {
    return (
        <header style={{margin:'0px auto', padding:'auto', width: '1440px', height: '75px', 
                textAlign: 'center', backgroundColor:'transparent'}}>
            <nav style={{width: '1230px', height: '75px', left: '105px', 
                margin:'auto', padding: 'auto', 
                backgroundColor:'transparent', display:'inline-flex'}}>
                <img src="/images/IMAGE.png" 
                    style={{width: '106px', height: '37px', left: '50px', top: '19px', 
                        borderRadius:0, border: 'none', margin:'auto'}} />
                <div style={{width:'1000px', height:'36px', top:'19.5px', left:'180px', 
                    display:'inline-flex', margin:'auto'}}>
                    <ul 
                        style={{padding:'8px 16px', margin:'0 auto', width:'756.578125px',
                            fontSize:'15px', display:'inline-flex'}}>
                        <li 
                            style={{width:'64px', height:'24px', top:'6.5px', left:'12px', 
                                fontSize:'15px'}}
                        >Features</li>
                        <li 
                            style={{width:'64px', height:'24px', top:'6.5px', left:'100px', 
                                fontSize:'15px'}}
                        >Pricing</li>
                        <li 
                            style={{width:'89px', height:'24px', top:'6.5px', left:'175px', 
                                fontSize:'15px'}}
                        >Integration</li>
                        <div
                            style={{width:'72px', height:'26px', top:'5.5px', left:'282px', 
                                fontSize:'15px'}}
                        >
                    ...
                    <div style={{marginRight:'0px', width:'243.42px', height:'36px', 
                        left:'756.58pxs', display:'inline-flex'}}>
                        <div
